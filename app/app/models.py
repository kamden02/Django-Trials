...
class User(UserMixin, db.Model):
	...
	def generate_cofirmation_token(self, expiration=3600):
	...
	def __init__(self, **kwags):
		super(User, self).__init__(**kwags)
	...
	def is_adminstrator(self):
		return self.con(Permission.ADMIN)
...
class Role(db.Model):
	...
	def __init__(self, **kwags):
		super(Role, self).__init__(**kwags)
	...
	def insert_roles():
		reles={
			'User': [Permission.FOLLOW, Permission.COMMENT, Permissions.WRITE],  
